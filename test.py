...
def main(args):
    ...
    meta_test_dataloader =  DataLoader(benchmark.meta_val_dataset,
                                              batch_size=4,
                                              shuffle=False,
    ...
    results = metalearner.evaluate(meta_test_dataloader,
                                   ...
                                   desc='Test')
    for name, param in metalearner.model.named_parameters():
        if param.requires_grad:
            print( name, param.data)
    print(metalearner.model)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str,default='results/2020-04-03_021213/config.json',
