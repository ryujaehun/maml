...
class Conv2dGraphDataset(Dataset):
    def __init__(self, ways=5, shot=5, test_shot=5, size=10000000, transform=None,val=False,template=False):
        self.shot = shot
        self.ways = ways
        self.test_shot = test_shot
        self.__save_path='/home/jaehun/workspace/incubator-tvm/result/GCN_conv2d'
        self.transform=transform

        self.__tasks =[]
        for i in range(0,23):
            self.__tasks.append(f'conv2d_{i}')
        if val:
            self.__tasks = ['conv2d',]
...
class Conv2d_2_GraphDataset(Dataset):
    def __init__(self, ways=5, shot=5, test_shot=5, size=10000000, transform=None,val=False,template=False):
        self.shot = shot
        self.ways = ways
        self.test_shot = test_shot
        self.__save_path='/home/jaehun/workspace/incubator-tvm/result/GCN_conv2d_2'
        self.transform=transform
